...
function generateBadges(stats: ActivityStats): string {
  const badges = [
    `![Recent Commits](https://img.shields.io/badge/Recent%20Commits-${stats.commitCount}-blue?style=flat-square&logo=git&logoColor=white)`,
    `![Active Repos](https://img.shields.io/badge/Active%20Repos-${stats.repoCount}-green?style=flat-square&logo=github&logoColor=white)`,
    `![Pull Requests](https://img.shields.io/badge/Pull%20Requests-${stats.prCount}-orange?style=flat-square&logo=githubactions&logoColor=white)`,
    `![Issues Opened](https://img.shields.io/badge/Issues%20Opened-${stats.issueCount}-red?style=flat-square&logo=githubactions&logoColor=white)`
  ];
